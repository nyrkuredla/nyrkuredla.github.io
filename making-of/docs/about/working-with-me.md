It's awfully hard to get a sense of what it's like to work with someone just from a [LinkedIn profile](https://linkedin.com/in/ryantkelley). It's probably not much easier via Markdown file, but I'll give it a shot. 

## Some basics
- Remote-first (in my case, *quite* remote), with structured on-site time for those quality in-person connections. 
- Low chaos, high trust, exceptional Slackmoji game (or so my teammates tell me). 
- I work hard and smart, AND deliberate pause and strategic repose are part of the discipline. In other words, I take work-life balance seriously. Constant firefighting is not a virtue.

## StrengthsFinder top 6
For those who like that kind of thing. As you'll no doubt gather, I *love* a tidy framework.

In order of resonance, highest first:

### Deliberative
I am careful, vigilant, and do not rush decisions, and I approach most situations with a certain reserve. I take the time to scan for risks, read between the lines, and weigh trade-offs and multiple perspectives, so that when I act, it's with clarity and confidence.

### Ideation
I get a rush from seeing the ways in which things connect. Bonus points if it's *elegant* ways that *seemingly complex and unrelated* things connect. If I'm not solving something, I'm probably mapping it. Signals from noise is my jam.
...
### Learner
My curiosity is never turned off, ever. I thrive in environments where I can pick up new skills, systems, or tools and immediately start playing with them, seeing what they do, and putting them to use. For me, the learning journey is the point more so than the destination.
...
### Harmony
I try to find the common ground. I'm good at sensing roadblocks and finding paths through them, especially in cross-functional work where clarity and cohesion are everything. I like collaboration that feels frictionless and productive, and I'll quietly cultivate it when needed.
